...
const SignInPage = function () {
    ...
    return (
        <div>
            ...
            <div className="signin_button" onClick={() => signInWithGoogle()} onKeyDown={() => signInWithGoogle()} role="button" tabIndex={0}>
                <img src={`${process.env.PUBLIC_URL}/images/google/1x/btn_google_signin_dark_disabled_web.png`} alt="google signin" />
            </div>
        </div>
    )
}
